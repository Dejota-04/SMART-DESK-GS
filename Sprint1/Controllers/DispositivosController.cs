...
namespace Sprint1.Controllers
{
    public class DispositivosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Uuid,DataCadastro")] Dispositivo dispositivo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Uuid,DataCadastro")] Dispositivo dispositivo)
        {
            if (id != dispositivo.Uuid)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!DispositivoExists(dispositivo.Uuid))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Dispositivos.Any(e => e.Uuid == id);
        }
    }
}
